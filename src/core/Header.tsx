...
import {getData, subscribeToUserChanges, loginPopup, logout, saveAll} from '../request/Request';
...
export class LoggedInApp extends React.Component<LoggedInAppProps, LoggedInAppState> {
  ...
  onDataArrived(data: UserData) {
    ...
    const root = new DataRootImpl(data, this.onUpdate, this.onSaverUpdate, saveAll);
